...
Web3Provider (outermost)
  └─ NexusProvider
      └─ Page Content (WalletConnection + UnifiedBalances)
```
...
**Why three layers?**
- QueryClientProvider → Handles data caching
- WagmiProvider → Handles blockchain connections
- ConnectKitProvider → Handles wallet UI
...
**Loading State:**
- If loading, shows "Loading balances... 🔄"
...
**Empty State:**
- If no balances, shows "Add test tokens! 💰"
...
User sees "Connect Wallet" button
      ↓
User clicks → ConnectKit modal opens
      ↓
User selects MetaMask (or other wallet)
      ↓
Wallet connects → isConnected becomes true
      ↓
...
- ✅ Technologies used (Next.js, Wagmi, Nexus SDK, Tailwind)
- ✅ Project structure and file organization
- ✅ How each component works
- ✅ The data flow from wallet to UI
- ✅ How to set up and run the project
- ✅ Advanced concepts (Context, Hooks, etc.)
